...
public class ResearchGroupController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ResearchGroup> getResearchGroupById(@PathVariable Long id) { // 🔹 Long
    ...
    public List<ResearchGroup> getResearchGroupsByCenter(@PathVariable Long centerId) { // 🔹 Long
