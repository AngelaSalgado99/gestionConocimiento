...
@Entity
@Table(name = "seedbed_members")
public class SeedbedMember {
    @Id
    ...
    private ResearchSeedbed researchSeedbed;  // Era "seedbed" - debe coincidir

    @Column(nullable = false)
    private LocalDate joinDate;

    private String affiliation; // Institución a la que pertenece el miembro

    // Constructores, getters y setters
    public SeedbedMember() {}
